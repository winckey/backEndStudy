                ...
                <form class="row g-3 needs-validation" novalidate>
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      <input type="text" v-model="$store.state.login.userId" class="form-control" placeholder="Id" />
                  ...
                  <div class="col-12">
                    ...
                    <input type="password" class="form-control" v-model="$store.state.login.userPass" required />
...
<script>
      ...
      login() {
        http
          .post("/login", {
            ...
            userPass: this.$store.state.login.userPass,
          })
          .then(({
            data
          }) => {
  ...
  // push 메소드를 사용하면 **히스토리 스택**에 추가 됩니다.
