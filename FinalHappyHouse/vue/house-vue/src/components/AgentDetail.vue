        ...
        <div class="container">
          <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="agent-avatar-box">
                    <img
                      v-bind:src="$store.state.agent.agentProfileImageUrl"
                      alt=""
                  ...
                  <div class="agent-info-box">
                    <div class="agent-title">
                      <div class="title-box-d">
                        <h3 class="title-d">{{ $store.state.agent.agentName }}</h3>
                      </div>
                    </div>
                    <div class="agent-content mb-3">
                      ...
                      <div class="info-agents color-a">
                        <p>
                          ...
                          <span class="color-text-a" style="font-size: 22px">{{
                            $store.state.agent.agentPhone
                          }}</span>
                        </p>
                        ...
                        <p>
                          ...
                          <span class="color-text-a" style="font-size: 22px">{{
                            $store.state.agent.agentEmail
                          }}</span>
                        </p>
                        <p>
                          &nbsp;&nbsp;&nbsp;&nbsp;
                          <i class="bi bi-heart" style="font-size: 1.5rem; color: crimson"></i>
                          <span class="color-text-a" style="font-size: 22px"
                            >&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>&nbsp;
                            {{ $store.state.agent.agentRate }}</span
                          >
                        </p>
                      </div>
                    </div>
            ...
            <div class="col-md-12 section-t8">
              <div class="title-box-d">
                <h3 class="title-d">
                  My Properties ({{ $store.state.agent.agentHouseList.length }})
                </h3>
              </div>
            </div>
            <div class="row property-grid grid">
              ...
              <div
                class="col-md-4"
                v-for="(house, index) in this.$store.state.agent.agentHouseList"
                v-bind:key="index"
              >
                  ...
                  <div class="card-overlay">
                    <div class="card-overlay-a-content">
                      ...
                      <div class="card-body-a">
                        ...
                        <div id="detail" @click="houseDetail(house.houseNo)">
                          Click here to view
                          <span class="bi bi-chevron-right"></span>
                        </div>
                      </div>
                      <div class="card-footer-a">
                        <ul class="card-info d-flex justify-content-around"></ul>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    agentDetail() {
      ...
      http
        ...
        .then(({ data }) => {
          ...
          this.$store.commit("SET_AGENT_DETAIL", {
