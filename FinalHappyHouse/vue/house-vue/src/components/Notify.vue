  ...
  <div class="container">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr style="cursor: pointer" v-for="(board, index) in listGetters" @click="boardDetail(board.boardId)"
          v-bind:key="index">
          <!-- 직접 접근하지 않고 함수로 접근  -->
          <td>{{ board.boardId }}</td>
          <td>{{ board.title }}</td>
    ...
    <button v-show="position" class="btn btn-sm btn-outline-success" @click="showInsertModal">글쓰기</button>
    ...
    <!-- props 제거 -->
    <detail-modal v-on:call-parent-change-to-update="changeToUpdate" v-on:call-parent-change-to-delete="changeToDelete">
    </detail-modal>
